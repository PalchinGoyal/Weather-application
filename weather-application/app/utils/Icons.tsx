import { CalendarDays, CloudDrizzle, CloudRain, CloudSun, Cloudy, Command, Droplet, Droplets, Eye, Gauge, Github, Navigation, Search, Snowflake, Sun, Sunset, Thermometer, ThermometerSun, UsersRound, Wind } from "lucide-react";
